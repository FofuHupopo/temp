    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('converse', models.BooleanField(default=False, verbose_name='Обратный?')),
        ...
        migrations.CreateModel(
            name='HubsToPriceModel',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('distance', models.FloatField(default=-1, verbose_name='Расстояние')),
                ('hours_duration', models.IntegerField(default=-1, verbose_name='Часы')),
                ('minutes_duration', models.IntegerField(default=-1, verbose_name='Минуты')),
                ('hub', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='address.hub', verbose_name='В хаб')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hubs', models.ManyToManyField(blank=True, to='tariffs.hubstopricemodel', verbose_name='В хабы')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(blank=True, max_length=128, null=True, unique=True, verbose_name='Название')),
                ('type', models.CharField(choices=[('basic', 'Основной'), ('commission', 'Комиссионный'), ('company', 'Для компании')], default='Основной', max_length=32, verbose_name='Тип')),
                ...
                ('last_update', models.DateTimeField(default=django.utils.timezone.now, verbose_name='Последнее изменение')),
                ...
                ('company', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='profile.company', verbose_name='Компания')),
        ...
        migrations.AddField(
            ...
            name='prices',
            field=models.ManyToManyField(blank=True, to='tariffs.pricetocarclass', verbose_name='Цены к классу авто'),
        ),
        migrations.AddField(
